    ...
    <div>
        <form id="pedido form">
            ...
            <div class="inputs">
                ...
                <select name="ponto-carne" id="ponto-carne" v-model="pontoCarneSelecionar">
                    <option value="" selected>Selecione o Ponto da Carne</option>
