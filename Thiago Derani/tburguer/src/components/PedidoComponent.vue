    ...
    <div>
        <form id="pedido-form">
            ...
            <div id="opcionais-titulo" class="inputs">
                ...
                <label id="opcionais-subtitulo" for="Complemento">Adcione um complemento</label>

                <div class="checkbox-container">
                    <input type="checkbox" name="complemento" valeu="1" v-model="listaComplementosSelecionados">
                    <span>Batata</span>
                </div>

                <label for="Complemento">Adicione uma bebeida</label>

                <div class="checkbox-container">
                    <input type="checkbox" name="complemento" valeu="1" v-model="listaBebidaSelecionados">
                    <span>Refri</span>
                </div>
            </div>
            <div class="inputs">
                <input type="submit" class="submit-btn" valeu="Confirmar Pedido">
            </div>
        </form>
...
<script>
    export default{
        name:"PediddComponent",
        data(){
            return{
                nomeCliente:"",
                pontoCarneSelecionado:"",
                listaComplementosSelecionados:"",
                listaBebidaSelecionados:"",
                listaPontoCarne:[],
                listaComplementos :[],
                listaBebida:[]
            }
        ...
        methods:{
            ...
            async getOpcionais(){
                ...
                this.listaBebidas = lista.bebidas;
            }
        },
        mounted(){
            this.getTipoPontos();
